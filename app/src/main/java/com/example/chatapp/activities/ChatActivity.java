...
public class ChatActivity extends BaseActivity {
    ...
    private void listenAvailabilityOfReceiver(){
        db.collection(Constants.KEY_COLLECTIONS_USERS).document(receiverUser.id)
    ...
    private void listenMessages(){
        db.collection(Constants.KEY_COLLECTION_CHAT).whereEqualTo(Constants.KEY_SENDER_ID, preferenceManager.getString(Constants.KEY_USER_ID))
                .whereEqualTo(Constants.KEY_RECEIVER_ID, receiverUser.id)
                .addSnapshotListener(eventListener);
        db.collection(Constants.KEY_COLLECTION_CHAT).whereEqualTo(Constants.KEY_SENDER_ID, receiverUser.id)
    ...
    private final EventListener<QuerySnapshot> eventListener = (value, error)->{
        ...
        if (value != null) {
            ...
            Collections.sort(chatMessages, (a1, a2)->a1.dateObject.compareTo(a2.dateObject));
            if(count == 0){
    ...
    private void addConversation(HashMap<String, Object>conversation){
        db.collection(Constants.KEY_COLLECTIONS_CONVERSATIONS)
                .add(conversation)
                .addOnSuccessListener(documentReference -> documentReference.getId());
    }
    private void updateConversation(String message){
        DocumentReference documentReference = db.collection(Constants.KEY_COLLECTIONS_CONVERSATIONS).document(conversationId);
    ...
    private void checkForConversationRemotely(String senderId, String receiverId){
        db.collection(Constants.KEY_COLLECTIONS_CONVERSATIONS)
                ...
                .get().addOnCompleteListener(conversationsOnCompleteListener);
    }
