...
public class MainActivity extends BaseActivity implements ConversationListener {
        ...
        if (value != null) {
            for (DocumentChange documentChange : value.getDocumentChanges()) {
                if (documentChange.getType() == DocumentChange.Type.ADDED) {
                    ...
                    if (preferenceManager.getString(Constants.KEY_USER_ID).equals(chatMessage.senderId)) {
            ...
            Collections.sort(conversations, (a1, a2) -> a2.dateObject.compareTo(a1.dateObject));
    ...
    private void signOut(){
        ...
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        DocumentReference documentReference = db.collection(Constants.KEY_COLLECTIONS_USERS)
